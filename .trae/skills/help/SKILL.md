---
name: "help"
description: "Provides onboarding and usage help for the interview assistant. Invoke when user asks how to use the project, wants a quick start, or enters /help."
---

# Help

用于向用户清晰介绍当前面试助手的功能、输入材料、能力边界和推荐起手方式。
